  ...
  module MappingRegistry
    ...
    Registry.register(
      ...
      :schema_element => [ :choice,
        ...
        ["mailingCenterPostOffice", "PortfolioManager::Xml::OtherType[]"],
        ...
        ["automobileDealership", "PortfolioManager::Xml::OtherType[]"],
    ...
    Registry.register(
      :class => PortfolioManager::Xml::OtherType,
      :schema_name => XSD::QName.new(nil, "automobileDealership"),
      :schema_element => [
        ["name", nil],
        ["useDetails", "PortfolioManager::Xml::OtherType::UseDetails"],
        ["audit", "PortfolioManager::Xml::LogType", [0, 1]]
    ...
    Registry.register(
      ...
      :schema_qualified => false,
      :schema_element => [
        ["meterType", "PortfolioManager::Xml::AllMeterTypes[]", [0, nil]]
      ]
    )
